...
def index(request):
    ...
    if request.method=="POST":
     ...
     return render(request,'tour_and_travalling/home/index.html',{'pack':pack,'search':search})
    
    pack=package.objects.all()
    return render(request,"tour_and_travalling/home/index.html",{'pack':pack} )
    

def admin_home(request):
 return render(request,"tour_and_travalling/admin_home.html")

def search(request):
    
    return render(request,"tour_and_travalling/home/search.html")

def offers(request):
    pack=package.objects.all()
    return render(request,"tour_and_travalling/home/offers.html",{'pack':pack})
...
def loginuser(request):  
      ...
      return render(request,"tour_and_travalling/home/login.html",context)
...
def register(request):
    ...
    return render(request,"tour_and_travalling/home/register.html" )
...
def payment_tour(request):
    ...
    return render(request,"tour_and_travalling/home/payment.html" )  
...
def profile_management(request):
     ...
     return render(request,"tour_and_travalling/home/profile-management.html" )
...
def profile(request):
    ...
    return render(request,"tour_and_travalling/home/profile.html",{'book':book,'user':user,'reg':reg,'user_name':user_name})

def payment_history(request):
    return render(request,"tour_and_travalling/home/payment-history.html")
...
def place_info(request):
   ...
   user=request.user
   return render(request,"tour_and_travalling/home/place_info.html",{'place':place,'pack':pack,'att':att,'feed':feed,'user':user})
...
def superadmin (request):
    ...
    return render(request,"tour_and_travalling/admin/admin.html",{'pay':pay,'num':range(1, total_users),'book':book,'pack':pack,'rat':rate,'reg':reg,'user':user,'hotels':hotels,'total_users':total_users,
...
def Review(request):   
    if request.method=="POST":
        ...
        pack=package.objects.all()
        att=Attractions.objects.all()
        return render(request,"tour_and_travalling/home/place_info.html",{'feed':feed,'place':place,'pack':pack,'att':att})  
    else:
        pack=package.objects.all()
        user=User.objects.all()
        ...
        place=request.GET.get('place_name')  
        reg= ragister.objects.all()
    return render(request,"tour_and_travalling/home/Review.html",{'user':user,'pack':pack,'place':place,'un':user_name,'reg':reg})     
...
def manageuser(request):
    if request.method == "POST":
          ...
          my_use.save()
          return redirect("index")
    return render(request,"tour_and_travalling/admin/manageuser.html")
...
def managehotel(request):
     ...
     return render(request,"tour_and_travalling/admin/managehotel.html")
...
def managepackeg(request):
    ...
    return render(request,"tour_and_travalling/admin/managepackeg.html")


def managefeedback(request):
    return render(request,"tour_and_travalling/admin/managefeedback.html")
def addpack(request):
    if request.method == "POST":  
     print("in add pack")
    else:
...
def managepayment(request):
    ...
    return render(request,"tour_and_travalling/admin/managepayment.html")
...
def managerating(request):
    ...
    return render(request,"tour_and_travalling/admin/managerating.html",{'rat':rat,'r_id':int(r_id)})

def upi(request):
    # name=request.session['name']
    # pack=package.objects.all().filter(place_name=name)
    price=request.GET.get('price') 
    return render(request,"tour_and_travalling/home/upi.html",{'price':price})
...
def showuserdata(request):
    ...
    return render(request,"tour_and_travalling/admin/showuserdata.html",{'reg':reg})
...
def showhotel(request):
    ...
    return render(request,"tour_and_travalling/admin/showuserdata.html",{'hot':hot})
...
def editpackeg(request):
    ...
    return render(request,"tour_and_travalling/admin/editpackeg.html",{'pack':obj})
...
def edithotel(request):
    ...
    return render(request,"tour_and_travalling/admin/edithotel.html",{'htl':obj})